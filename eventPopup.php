...
<!--                            <img src="/common/img/main/2408-event-popup.jpg?v=--><?php //echo date("ymdHi") ?><!--" alt="8월 이벤트 팝업">-->
<!--                        </a>-->
<!--                    </figure>-->
<!--                </div>-->
                <!-- <div class="swiper-slide">
                    <figure>
                        <a style="cursor: default;">
                            <img src="/common/img/main/event-summer-popup.jpg?v=<?php echo date("ymdHi") ?>" alt="썸마할인 이벤트 팝업">
                        </a>
                    </figure>
                </div> -->
                <div class="swiper-slide">
                    <figure>
                        <a style="cursor: default;">
                            <img src="/common/img/main/event-popup02.jpg?v=<?php echo date("ymdHi") ?>" alt="애교살 반영구 팝업">
                        </a>
                    </figure>
                </div>
                <div class="swiper-slide">
                    <figure>
                        <a style="cursor: default;">
                            <img src="/common/img/main/evPop-demomodel-popup.jpg?v=<?php echo date("ymdHi") ?>" alt="두피 문신 모델 모집">
                        </a>
                    </figure>
                </div>
                <div class="swiper-slide">
                    <figure>
                        <a href="https://www.toxnfillbrow.com/contact/index.php">
                            <img src="/common/img/main/evPop-discount-popup.jpg?v=<?php echo date("ymdHi") ?>" alt="두피문신 할인 event">
                        </a>
                    </figure>
                </div>
			</div>
