...
<div id="wrap">
	...
	<main id="container" class="main-section">
		...
		<section id="scroll-section-0" class="sc-video-bg">
            <div class="youtube-sec">
                <div class="youtube-wrap">
                    <iframe width="1236" height="695" src="https://www.youtube.com/embed/5VE44dgfSCo?rel=0&autoplay=1&mute=1&enablejsapi=1&controls=0&loop=1&playlist=5VE44dgfSCo" title="두피문신 80%할인 시술 기회를 꼭 잡으세요 일상이 변했어요!" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
		...
		<section id="scroll-section-1" class="cate-sec">
			<div class="minframe">
				...
				<ul class="cate-wrap">
					...
					<!-- 240621 임시 미노출 -->
					<li>
						<a href="https://dg.toxnfillbrow.com/m/curriculum/index.php" title="수강 커리큘럼">
							<span class="icon">
					...
					<li>
						<a href="https://dg.toxnfillbrow.com/m/intro/browSpace.php" target="_blank" title="오시는길">
							<span class="icon">
			...
			<div class="cont_wrap">
				<div class="cont_inner">
					...
					<div class="btn_wrap">
						...
						<a class="btn btn-dark" href="/m/commu/review.php" title="리뷰 게시판">
							더 많은 후기 보러가기
						</a>
					</div>
				</div>
		...
		<section id="scroll-section-3" class="tech-sec">
			...
			<div class="techSwiper _techSwiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<figure>
							<img src="/common/img/m/main/tech-bg01.jpg?v=2407021734" alt="">
						</figure>
						<div class="txt_box">
							<p class="tit_">SMP</p>
							<p class="desc">
							...
							<div class="btn-rotate-wrap">
								<span class="center-icon icon">
									<img src="/common/img/m/main/i-deco-center-color-renew.png" alt="">
								</span>
								<a class="line-icon icon" href="/m/introduction/index.php">
									<img class="rotate_icon__" src="/common/img/m/main/i-deco-line-color-renew.png" alt="">
								</a>
							</div>
						</div>
					...
					<div class="swiper-slide">
						<figure>
							<img src="/common/img/m/main/tech-bg02.jpg?v=2407021734" alt="">
						</figure>
						<div class="txt_box">
							<p class="tit_">TSMP</p>
							<p class="desc">
					...
					<div class="swiper-slide">
						<figure>
							<img src="/common/img/m/main/tech-bg03.jpg?v=2407021734" alt="">
						</figure>
						<div class="txt_box">
		...
		<section id="scroll-section-4" class="curriculum-sec" >
			<div class="inner" style="background-color: #2F1830;">
				<div class="inner-frame">
					<div class="title_wrap">
						<h2 class="title img_">
							<img src="/common/img/m/main/curriculum-tit-renew.png" alt="">
						</h2>
					</div>
					<div class="curriculSwiper">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<figure class="img__">
									<img src="/common/img/m/main/curriculum-01.jpg?v=2407021738" alt="">
								</figure>
								<div class="txt_box_">
									<p class="tit_">
										SMP<br/>베이직 클래스
							...
							<div class="swiper-slide">
								<figure class="img__">
									<img src="/common/img/m/main/curriculum-04.jpg?v=2407021738" alt="">
								</figure>
								<div class="txt_box_">
									<p class="tit_">
										TSMP<br/>심화 클래스
							...
							<div class="swiper-slide">
								<figure class="img__">
									<img src="/common/img/main/curri-smp-all-master.jpg?v=2408070941" alt="커리큘럼">
								</figure>
								<div class="txt_box_">
									<p class="tit_">
										SMP ALL<br/>마스터 클래스
							...
							<div class="swiper-slide">
								<figure class="img__">
									<img src="/common/img/m/main/curriculum-02.jpg?v=2407021738" alt="">
								</figure>
								<div class="txt_box_">
									<p class="tit_">
										SMP<br/>창업 클래스
							...
							<div class="swiper-slide">
								<figure class="img__">
									<img src="/common/img/main/curri-smp-speed.jpg?v=2408061632" alt="커리큘럼">
								</figure>
								<div class="txt_box_">
									<p class="tit_">
										SMP<br/>속성 클래스
							...
							<div class="swiper-slide">
								<figure class="img__">
									<img src="/common/img/main/curri-femme-smp.jpg?v=2408061632" alt="커리큘럼">
								</figure>
								<div class="txt_box_">
									<p class="tit_">
										SMP<br/>숱채움 마스터 클래스
							...
							<div class="swiper-slide">
								<figure class="img__">
									<img src="/common/img/main/curri-brow.jpg?v=2408061632" alt="커리큘럼">
								</figure>
								<div class="txt_box_">
									<p class="tit_">
										눈썹 단과반
							...
							<div class="swiper-slide">
								<figure class="img__">
									<img src="/common/img/m/main/curriculum-07.jpg?v=2407021738" alt="">
								</figure>
								<div class="txt_box_">
									<p class="tit_">
										사후 과정
			...
			<p class="deco-bg">
				<img src="/common/img/m/main/deco-bg-renew.png" alt="">
			</p>
		</section>
		<!-- 포트폴리오 -->
			...
			<div class="minframe">
				...
				<div class="cont_wrap">
					...
					<div class="btn_wrap">
						...
						<a class="btn btn-dark" href="/m/commu/studentWork.php" title="포트폴리오 게시판">
							더 많은 수강생 작품 보러가기
						</a>
					</div>
				</div>
...
<script>
    $(document).ready(function(){
        var mainContent = $('.sc-video-bg .mainSwiper');
        mainContent.addClass('scroll-position');
        $(window).scroll(function(){
            var scroll = $(window).scrollTop();
            if (scroll > 115) {
                mainContent.removeClass('scroll-position');
            } else {
                mainContent.addClass('scroll-position');
            }
        })
