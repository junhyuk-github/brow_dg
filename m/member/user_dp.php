		...
		<div id="userTab">
			...
			<div>
				<div id="tab-panel1" class="tab-panel" role="tabpanel" aria-labelledby="tab1">
					...
					<div class="joinForm-wrap" style="margin-top:0;">
								...
								<table>
									...
									<tbody>
										<tr scope="row">
											...
											<td>
												<input type="text" id="userName" name="userName" value="<?=$userName?>" placeholder="" class="form-control">
											</td>
										</tr>
										<tr scope="row">
											<th><span class="req">아이디</span></th>
											<td>
												<input type="text" id="userID" name="userID" value="<?=$userID?>" placeholder="" class="form-control" readonly>
											</td>
										</tr>
										<tr scope="row">
											<th><span class="req">비밀번호</span></th>
											<td>
												<input type="password" id="userPWD" name="userPWD" value="" placeholder="" class="form-control">
										...
										<tr scope="row">
											...
											<td>
												<input type="password" id="userPWD1" name="userPWD1" value="" placeholder="" class="form-control">
										...
										<tr scope="row">
											...
											<td class="short-hz">
												...
												<div class="phone-ipt">
													<input type="number" id="userMobile2" name="userMobile2" value="<?=$userMobile2?>" placeholder="" class="form-control">
												</div>
												<div class="phone-ipt">
													<input type="number" id="userMobile3" name="userMobile3" value="<?=$userMobile3?>" placeholder="" class="form-control">
												</div>
											</td>
										</tr>
										<tr scope="row">
											...
											<td>
												<ul class="short-hz">
													<li class="email-id">
														<input type="text" id="userMail1" name="userMail1" value="<?=$userMail1?>" placeholder="" class="form-control">
													</li>
													<li class="email-adr">
														<input type="text" id="userMail2" name="userMail2" value="<?=$userMail2?>" placeholder="" class="form-control">
													</li>
												</ul>
										...
										<tr scope="row">
											...
											<td>
												<div class="ipt-btn-box">
													<input type="text" id="userZip" name="userZip" value="<?=$userZip?>" placeholder="" class="form-control" readOnly ontouchend="openPostcode(this.form);"><button type="button" ontouchend="openPostcode(this.form);">우편번호</button>
												</div>
												<input type="text" id="userAddr1" name="userAddr1" value="<?=$userAddr1?>" placeholder="" class="form-control" style="margin-top:5px;" readOnly ontouchend="openPostcode(this.form);"><br/>
												<input type="text" id="userAddr2" name="userAddr2" value="<?=$userAddr2?>" placeholder="" class="form-control" style="margin-top:5px;">
											</td>
										</tr>
										<tr scope="row">
											<th>생년월일</th>
											<td>
												<input type="number" id="userBirth" name="userBirth" value="<?=$userBirth?>" placeholder="" class="form-control"><br/>
												<span>(예: 950115)</span>
											</td>
										</tr>
										<tr scope="row">
						...
						<div class="ja-btn-wrap">
							...
							<a style="cursor:pointer;" onClick="memberModify();" class="goNext">회원정보 수정</a>
						</div>
					</div>
					</form>
				</div>
				...
				<div id="tab-panel2" class="tab-panel" role="tabpanel" aria-labelledby="tab2">
					<form id="" name="" method="" style="margin-top:0;margin-bottom:0">
