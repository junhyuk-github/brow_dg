...
<div id="">
	...
	<div class="idpws-cont">
		...
		<section>
			<h2>아이디찾기</h2>
			<input type="text" id="findName" name="findName" value="" placeholder="이름을 입력해주세요" class="form-control">
			<input type="text" id="findMail" name="findMail" value="" placeholder="이메일을 입력해주세요" class="form-control">
			<button type="button" ontouchend="findID();">아이디 찾기</button>
		</section>
		</form>
		...
		<section>
			<h2>비밀번호 찾기</h2>
			<input type="text" id="findID" name="findID" value="" placeholder="아이디를 입력해주세요" class="form-control">
			<input type="text" id="findMobile" name="findMobile" value="" placeholder="휴대폰 번호를 입력해주세요 ('-' 제외하고 입력)" class="form-control">
			<button type="button" ontouchend="findPWD();">임시 비밀번호 발송</button>
		</section>
		</form>
	</div>
</div>
