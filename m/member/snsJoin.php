<!-- https://www.toxnfillacademy.com/m/member/snsJoin.php 톡스앤필 뷰티 아카데미 페이지에서 소스코드 가지고 왔습니다. -->
<?php
			...
			<div class="sns-join-wrap">
				...
				<div class="joinForm-wrap">
							...
							<tbody>
								...
								<tr scope="row">
									...
									<td>
										...
										<select id="selMail" name="selMail" class="form-control" onChange="chgMail(this.value);" style="margin-top:5px;">
								...
								<tr scope="row">
									...
									<td class="short-hz">
										...
										<div class="phone-ipt">
											<input type="number" id="userMobile2" name="userMobile2" value="" placeholder="" class="form-control">
										</div>
										<div class="phone-ipt">
											<input type="number" id="userMobile3" name="userMobile3" value="" placeholder="" class="form-control">
										</div>
									</td>
								</tr>
							</tbody>
					...
					<div class="ja-btn-wrap">
						<a style="cursor:pointer;" onClick="goNextStep();" class="goNext">가입완료</a>
					</div>
				</div>
			</div>
			</form>
