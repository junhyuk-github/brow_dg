								...
								<tr scope="row">
									...
									<td>
										<div class="wrap __phone">
											...
											<input type="number" id="userMobile2" name="userMobile2" value="<?=$userMobile2?>" placeholder="">
											<input type="number" id="userMobile3" name="userMobile3" value="<?=$userMobile3?>" placeholder="">
										</div>
										<button class="btn-blk">인증번호 요청</button>
									</td>
								</tr>
								<tr scope="row">
					...
					<div class="pop-detail-wrap">
						<div class="pop-inner">
							...
							<div class="text-center">
								<!-- 1. 사용 전일 경우 -->
								<button class="btn-use able-c">쿠폰 사용 처리 <span>(직원 확인용)</span></button>
								 <!-- 2. 사용완료일 경우 -->
