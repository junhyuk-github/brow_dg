		...
		<div class="join-agree-wrap">
			...
			<div class="minframe">
				<div class="joinForm-wrap">
					<h3 class="notice-txt"><span class="req">항목</span>은 필수 항목입니다.</p></h3>
					...
					<table class="join-form">
						...
						<tbody>
							...
							<tr scope="row">
								...
								<td>
									<div class="input-btn-box">
										<input type="text" id="userID" name="userID" value="" maxlength="12" onkeyup="userIDEvt(event);" onkeydown="userIDEvt(event);"/>
							...
							<tr scope="row">
								...
								<td>
									<input type="password" id="userPWD" name="userPWD" value="" placeholder=""><br/>
							...
							<tr scope="row">
								...
								<td>
									<input type="password" id="userPWD1" name="userPWD1" value="" placeholder=""><br/>
							...
							<tr scope="row">
								...
								<td>
									<div class="wrap __phone">
										...
										<input type="number" id="userMobile2" name="userMobile2" value="" placeholder="" maxlength="4" oninput="mobileMaxLengthChk(this)">
										<input type="number" id="userMobile3" name="userMobile3" value="" placeholder="" maxlength="4" oninput="mobileMaxLengthChk(this)">
									</div>
									<button type="button" class="btn-blk" id="sendBtn1" onClick="sendCertNo();" style="">
										인증번호요청
									</button>
									<button type="button" class="btn-gray" id="sendBtn2" onClick="sendCertNo();" style="display:none;width:100%;margin-top:0.5rem;">
										재발송
									</button>
								</td>
							</tr>
							...
							<tr scope="row">
								...
								<td>
									<div class="wrap __email">
										<input type="text" id="userMail1" name="userMail1" value="">
										<p>@</p>
										<input type="text" id="userMail2" name="userMail2" value="" placeholder="">
									</div>
							...
							<tr scope="row">
								...
								<td>
									<div class="input-btn-box">
										<input type="text" id="userZip" name="userZip" value="" placeholder="" readOnly ontouchend="openPostcode(this.form);">
										<button type="button" ontouchend="openPostcode(this.form);" class="btn-gray">우편번호</button>
									</div>
									<input type="text" id="userAddr1" name="userAddr1" value="" placeholder="" style="margin-top:5px;" readOnly ontouchend="openPostcode(this.form);"><br/>
									<input type="text" id="userAddr2" name="userAddr2" value="" placeholder="" style="margin-top:5px;">
								</td>
							</tr>
							<tr scope="row">
								<th>생년월일</th>
								<td>
									<input type="number" id="userBirth" name="userBirth" value="" placeholder="" maxlength="6"><br/>
									<span>(예: 950115)</span>
								</td>
							</tr>
							<tr scope="row">
...
function sendCertNo()
{
	...
	$.ajax({
		url						:	"/member/memberJoinCertNoProc.php",
		type					:	"POST",
		data					:	postDate,
		dataType				:	"html",
...
function commendChk()
{
	...
	$.ajax({
		type					:	"POST",
		url						:	"/member/_commendChkProc.php",
		dataType				:	"json",
		data					:
		{
			chkNo : chkNo
