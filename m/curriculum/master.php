...
<div id="wrap" class="">
	...
	<div id="container">
		...
		?>
		<div id="titBanner" style="background-image:url('/common/img/m/curriculum/banner2.jpg');">
				...
				<div class="minframe">
					<div class="inner">
						<div class="gc-tit">
							<h3>마스터 과정</h2>	
							<p>
								최신 트렌드 반영구 종목 전반을 익힌 후에 <br>
								글로벌한 고난이도 눈썹 테크닉인 <br>
								‘마이크로 블레이딩’을 집중적으로 익힐 수 있는 고급 과정
							</p>
						</div>
						<div class="gc-cont">
							<table>
								...
								<tbody>
									...
									<tr>
										<th>교육 과목 </th>
										<td>
											<em style="color: #A73439;">*마스터 과정 전용 교육</em>
											<em style="color: #A73439;">- 마이크로 블레이딩 (마스터 과정 전용 고난이도 문신 테크닉)</em>
					...
					<div class="gc-cont">
						<div class="info-box">
							<table>
								<tbody>
									<tr>
										<td style="background-image:url(/common/img/m/curriculum/2-1-bg.jpg)">
										...
										<td class="white" style="background-image:url(/common/img/m/curriculum/2-2-bg.jpg)">
											<div class="info-item text-vertical-center">
												<div class="vertical-middle txt_frame">
									...
									<tr>
										<td class="white" style="background-image:url(/common/img/m/curriculum/2-3-bg.jpg)">
											<div class="info-item text-vertical-center">
												<div class="vertical-middle txt_frame">
										...
										<td style="background-image:url(/common/img/m/curriculum/2-4-bg.jpg)">
											<div class="info-item text-vertical-center">
												<div class="vertical-middle txt_frame">
									...
									<tr>
										<td style="background-image:url(/common/img/m/curriculum/2-5-bg.jpg)">
											<div class="info-item text-vertical-center">
												<div class="vertical-middle txt_frame">
										...
										<td class="white" style="background-image:url(/common/img/m/curriculum/2-6-bg.jpg)">
											<div class="info-item text-vertical-center">
												<div class="vertical-middle txt_frame">
