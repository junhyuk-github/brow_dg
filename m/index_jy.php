...
<div id="wrap" class="main">
	...
	<div id="container">
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="main-visual-banner" 
							style="background-image:url('/common/img/banner/1-m.jpg?ver=2');" onclick="window.location='http://toxnfillbrow.com/m/intro/index.php'">
						</div>
					</div>
					<div class="swiper-slide">
						<div class="main-visual-banner" 
							style="background-image:url('/common/img/banner/2-m.jpg');" onclick="window.location='http://toxnfillbrow.com/m/intro/index.php'">
						</div>
					</div>
					<div class="swiper-slide">
						<div class="main-visual-banner" 
		...
		<div class="main-section">
			...
			<section class="ms-3" style="background-image:url('/common/img/m/main/banner1.jpg')" 
				onclick="window.location='/m/intro/index.php'">
	...
	<?php
	include $_SERVER['DOCUMENT_ROOT'] . '/common/commonPage/floating-m_dev.php';
	?>
