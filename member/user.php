...
<body class="pg-detail no-footer-top nav-blk">
	<div id="wrap" class="main">
		<?php include $_SERVER['DOCUMENT_ROOT'] . '/common/commonPage/gnb_main.php'; ?>
				...
				<div class="coupon-wrap">
					<div class="left-wrap">
						...
						<div class="user-inner">
							...
							<b class="user-name"><?=$userName?></b>님 <br>안녕하세요.
							<div class="copy-wrap">
								추천인코드
									...
									<tr scope="row">
										...
										<td>
											<div class="wrap __phone">
												<select id="userMobile1" name="userMobile1" onkeyup="mobileChg();" onkeydown="mobileChg();">
	...
	<?php include $_SERVER['DOCUMENT_ROOT'] . '/common/commonPage/footer-main.php'; ?>
	...
	<script language="javascript">
		...
		function memberModify() {
			...
			if ( frm.userMobileChk.value == 'N' ) {
				alert("휴대폰 인증이 필요 합니다.");
				frm.userMobile1.focus();
				return false;
			}
		...
		function couponUsed(idx, userIdx, couponInfo) {
			console.log(idx);
...
<!--	DB Close Start	-->
<?php include $common['wwwPath'] . '/common/commonPage/_footer.php'; ?>
<!--	DB Close End	-->