		...
		<div class="loginForm-wrap">
			...
			<div class="inner">
				<div class="loginForm">
					...
					<a style="cursor:pointer;" onClick="loginChk();" class="login-btn">로그인</a>
				</div>

				<div class="social-box">
					<ul class="row">
						<li class="col-4">
							<a class="btn-sns-login" title="네이버 아이디로 로그인" style="line-height: 0;">
								<span id="naverIdLogin"></span>
								<span class="bsl-txt">로그인</span>
							</a>
						</li>
						<li class="col-4">
							<a class="btn-sns-login" style="cursor:pointer;" onClick="loginWithKakao();" title="카카오 아이디로 로그인"><span class="i-box box-kko"></span>로그인</a>
						</li>
						<li class="col-4">
							<a class="btn-sns-login" style="cursor:pointer;" onClick="checkLoginState();" title="페이스북 아이디로 로그인"><span class="i-box box-fb"></span>로그인</a>
						</li>
					</ul>
				</div>

				<ul class="login-other">
					<li><span>아이디/비밀번호를 잊으셨나요?</span><a onclick="Common.openWindow('/member/idpwSearch.php', 400, 700, 'idpwSearch', 50, 120);">아이디/비밀번호 찾기</a></li>
					<li><span>톡스앤필브로우 회원이 아니신가요?</span><a href="/member/join01.php">회원가입</a></li>
				</ul>
			</div>
		</div>
		</form>
