<link rel="stylesheet" href="/common/css/page.css?v=2401041529">
<?php
		...
		<div id="userTab">
			<div class="minframe">
				...
				<div id="tab-panel1" class="tab-panel" role="tabpanel" aria-labelledby="tab1">
					<?php
					include $_SERVER['DOCUMENT_ROOT'] . '/common/commonPage/classSubmit.php';
					?>
				</div>
				<div id="tab-panel2" class="tab-panel" role="tabpanel" aria-labelledby="tab2">
					<?php
					include $_SERVER['DOCUMENT_ROOT'] . '/common/commonPage/franchSubmit.php';
					?>
				</div>
				<div id="tab-panel3" class="tab-panel" role="tabpanel" aria-labelledby="tab3">
					<?php
					include $_SERVER['DOCUMENT_ROOT'] . '/common/commonPage/treatInquiry.php';
					?>
				</div>
			</div>
		</div>
