<link rel="stylesheet" href="/common/css/common_main.css?ver=2">
...
<div class="top-nav">
	<div class="maxframe">
		<ul class="top-right">
			...
			<? } ?>
			<li><a href="/contact/index.php">상담신청</a></li>
		</ul>
	</div>
	<div class="main-nav">
					...
					<ul class="depth1">
						...
						<li id="curriculum">
							...
							<ul class="depth2">
								...
								<li class="sub-ttl"><a href="/curriculum/index.php">SMP <br> 숱채움 마스터 클래스</a></li>
						...
						<li id="commu">
							...
							<ul class="depth2">
								...
								<li class="sub-ttl"><a class="btn-evPop">EVENT</a></li>
						...
						<div class="full-menu-wrap">
							...
							<div class="fullSns-wrap">
								<div class="sns-item">
									...
									<a href="https://www.instagram.com/toxnfillbrow_master/?igshid=YmMyMTA2M2Y%" target="_blank"><img src="/common/img/main/icon/i-insta-b.png" alt="인스타그램"></a>
									<!-- 추후 오픈
									<a href="https://www.youtube.com/@toxnfillacademybrow7885" target="_blank"><img src="/common/img/main/icon/i-youtube-b.png" alt="유튜브"></a>
									<a href="https://blog.naver.com/toxnfillbrow3" target="_blank"><img src="/common/img/main/icon/i-blog-b.png" alt="블로그"></a>
									-->
								</div>
