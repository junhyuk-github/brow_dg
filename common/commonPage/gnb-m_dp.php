			...
			<ul class="depth1">
				<li id="intro">
					...
					<ul class="acd-body depth2"> 
						...
						<!-- <li><a href="javascript:void(0);" onClick="alert('준비중입니다.')">ABOUT</a></li> -->
				...
				<li id="curriculum">
					...
					<ul class="acd-body depth2"> 
						...
						<li><a href="/m/curriculum/index.php">SMP 숱채움 마스터 클래스</a></li>
				...
				<li id="commu">
					...
					<ul class="acd-body depth2"> 
						...
						-->
						<li><a href="https://www.instagram.com/toxnfillbrow_master/?igshid=YmMyMTA2M2Y%3D" target="_blank">SNS</a></li>
						<!-- <li><a href="/m/commu/sns.php">SNS</a></li> -->
						<li><a class="btn-evPop" onClick="popupOpen()">EVENT</a></li>
						...
						<li><a href="javascript:void(0);" onClick="alert('준비중입니다.')">EVENT</a></li>
						-->
					</ul>
				</li>
				<li id="contact">
