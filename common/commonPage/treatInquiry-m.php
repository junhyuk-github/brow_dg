<div class="consult-inner __treat">
	...
	<div class="counsel-form text-center">
		<fieldset class="text-left">
			...
			<div class="privacy-wrap">
				<div class="form-checkbox">
					<input type="checkbox" class="" id="agree3" name="agree3" value="" tabindex="1">
