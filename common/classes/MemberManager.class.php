...
class MemberManager
{
	...
	public function userLoginProc($loginID, $loginPWD)
	{
		...
		$strSQL					=	"
									SELECT	corpCode, userIdx, userID, userName, userMobile, userMail, userGroup
									FROM tbl_academyMember
									WHERE userID = '$loginID' AND userPWD = PASSWORD('$loginPWD') AND corpCode = '$common[corpCode]' AND isOut = 'N' AND gubun = 'B'
									";
		//echo($strSQL);
		$msg					=	$this->dbm->execute($strSQL, '2');
		return $msg;
	...
	{	
		...
		$strSQL[] = "INSERT INTO tbl_academyMember
						(gubun, corpCode, userIdx, userID, userPWD, userName, userMobile, userMail, userBirth, userJob, userZip, userAddr1, userAddr2, userGroup, joinGubun, snsUserID, recommender, recommenderCode) VALUES
						('B', '$corpCode', $userIdx, '$userID', PASSWORD('$userPWD'), '$userName', '$userMobile', '$userMail', '$userBirth', '$userJob', '$userZip', '$userAddr1', '$userAddr2', '$userGroup', '$joinGubun', '$snsUserID', '$commendToken', '$recommenderCode')
					";
