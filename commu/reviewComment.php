...
?>
	...
	<div class="add-reply">
		...
		<div class="vw-comment-reg-box" id="replyRegMain_<?=$bIdx?>">
			<div class="inner">
				...
				<button type="button" class="btn-border" onClick="actionComment(this.form, 'frmComment_<?=$bIdx?>', 'commentDiv<?=$bIdx?>',  '','N');">등록</button>
			</div>
		</div>
	</div>
	</form>
	...
	<ul class="reply-list">
		...
		<li class="reply-item">
			<div class="rply-head">
				<span class="vw-id">
                    <?php if ($cUserGroup == '5' || $cUserGroup == '6') { ?>
			...
			<div class="add-reply">
				...
				<div class="vw-comment-reg-box" id="replyRegSub_<?=$bIdx?>_<?=$cIdx?>">
					<div class="inner">
						...
						<button type="button" class="btn-border" onClick="actionComment(this.form, 'frmComment_<?=$bIdx?>_<?=$cIdx?>', 'commentDiv<?=$bIdx?>', '','N');">등록</button>
					</div>
				</div>
			</div>
		</li>
