	...
	<div id="" class="board-frame acadNews">
		<div class="thumbnail">
			<div class="thumb-title">
                <img src="/common/img/title/academy_news.png" alt="">
            </div>
		</div>
		<div class="pg-tit">
			<h2>아카데미 뉴스</h2>
			...
			<div class="board-wrap">
                ...
                if ($bbsListTop) {
                    foreach ($bbsListTop as $val) {
                        ...
                        <ul class="list-wrap pin">
                            <li class="list"><span class="pin-txt">TOP</span><a href="/commu/acadNewsView.php?pno=<?=$page['pno']?>&idx=<?=$idx?>"><?=$subject?></a></li>
                ...
                if ($bbsList) {
                    foreach ($bbsList as $val) {
                        ...
                        ?>
                        <ul class="list-wrap">
                            <li class="list"><a href="/commu/acadNewsView.php?pno=<?=$page['pno']?>&idx=<?=$idx?>"><?=$subject?></a></li>
                            <li class="list date"><?=$regDate?></li>
                        </ul>
                        <?php
                    }
                ...
                ?>
<!--				<ul class="list-wrap pin">-->
<!--					<li class="list"><span class="pin-txt">TOP</span><a href="/commu/acadNewsView.php">주말 수강 시간 변동 안내</a></li>-->
<!--					<li class="list date">2023.07.12</li>-->
<!--				</ul>-->
<!--				<ul class="list-wrap">-->
<!--					<li class="list"><a href="/commu/acadNewsView.php">2023 아카데미 세미나 개최 안내2023 아카데미 세미나 개최 안내2023 아카데미 세미나 개최 안내2023 아카데미 세미나 개최 안내2023 아카데미 세미나 개최 안내2023 아카데미 세미나 개최 안내2023 아카데미 세미나 개최 안내2023 아카데미 세미나 개최 안내2023 아카데미 세미나 개최 안내2023 아카데미 세미나 개최 안내</a></li>-->
<!--					<li class="list date">2023.07.12</li>-->
<!--				</ul>-->
			</div>
		</div>
		...
		<ul class="pagi-wrap">
            <?php if ($bbsList) { ?>
                <?php if ($page['ppno'] != 1) { ?>
                    <li>
                        <a href="/commu/acadNews.php?pno=1">
                            <img src="/common/img/member/i-prev-first.png" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="/commu/acadNews.php?pno=<?=$page['spno']-1?>">
                ...
                for ($i = $page['spno']; $i <= $page['epno']; $i++) {
                    ...
                    ?>
                    <li class="pg-num <?=$isActive?>"><a href="/commu/acadNews.php?pno=<?=$i?>"><?=$i?></a></li>
                    <?php
                }
                ?>
                <?php if ($page['ppno'] != $page['maxPpno']) { ?>
                    <li>
                        <a href="/commu/acadNews.php?pno=<?=$page['epno']+1?>">
                            <img src="/common/img/member/i-next.png" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="/commu/acadNews.php?pno=<?=$page['pnoCount']?>">
