			...
			<div class="minframe">
				<section class="view-reg"> 
					<div class="vw-tit-box">
						...
						<div>
							...
							<button type="button" onclick="window.location='/member/login.php';" class="btn-border">로그인</button>
						</div>
						<? } ?>
					</div>
						...
						<div class="insert-box">
							<div class="">
								<div class="inner">
									...
									<button type="button" class="btn-border" onClick="formReview('', 'N');">등록</button>
									<? } else { ?>
									<textarea name="contents" id="contents" cols="" rows="4" class="form-control" placeholder="로그인 후 이용할 수 있습니다."></textarea>
									<button type="button" class="btn-border" onClick="alert('로그인 후 사용해주세요.');">등록</button>
									<? } ?>
								</div>
							</div>
				...
				<section class="view-list-area">
					<div class="vw-list-head">
						<span class="ttl-count">전체 후기 <?=$page['totalCount']?></span>
						<div class="vw-sort">
							<button type="button"<? if ( $order == '1' ) { echo 'class="active"'; } ?> onclick="window.location='<?=$selfPage?>?order=1';">최신순</button>
							<button type="button"<? if ( $order == '2' ) { echo 'class="active"'; } ?> onclick="window.location='<?=$selfPage?>?order=2';">오래된순</button>
						</div>
					</div>
					<ul class="vw-list">
						<?php
