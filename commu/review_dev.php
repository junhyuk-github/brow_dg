...
<div id="wrap" class="">
	...
	<div id="container">
		<div id="titBanner" style="background-image:url('/common/img/commu/banner4.jpg?ver=0302');">
						...
						<div class="vwrf-bottom">
							<div class="vw-comment-reg-box">
								<div class="inner">
									...
									<button type="button" class="btn-border" onClick="formReview('', 'N');">등&nbsp;&nbsp;록</button>
									<? } else { ?>
									<textarea name="contents" id="contents" cols="" rows="4" class="form-control" placeholder="로그인 후 이용할 수 있습니다."></textarea>
									<button type="button" class="btn-border" onClick="alert('로그인 후 사용해주세요.');">등&nbsp;&nbsp;록</button>
									<? } ?>
								</div>
							</div>
...
?>
<?php
include $_SERVER['DOCUMENT_ROOT'] . '/common/commonPage/floating.php';
?>
