...
<div id="wrap" class="main renewal pg-main">
	<?php
							...
							<a href="/curriculum/index.php">
								<div class="item-img">
									<figure class="img-frame">
										<img src="/common/img/main/curri-smp-basic.jpg?v=2407021421" alt="커리큘럼">
									</figure>
					  ...
					  <div class="swiper-slide" role="curriB">
						<div class="item_wrap">
							<a href="/curriculum/index.php">
								<div class="item-img">
									<figure class="img-frame">
										<img src="/common/img/main/curri-tsmp.jpg?v=2407021421" alt="커리큘럼">
									</figure>
									<a class="btn-read" href="/curriculum/index.php">
										<img class="img-read" src="/common/img/main/logo-read-w.png" alt="Read More">
										<img  class="img-read2"src="/common/img/main/logo-read2-w.png" alt="Read More">
					  ...
					  <div class="swiper-slide" role="curriD">
						<div class="item_wrap">
							<a href="/curriculum/index.php">
								<div class="item-img">
									<figure class="img-frame">
										<img src="/common/img/main/curri-smp-founded.jpg?v=2407021421" alt="커리큘럼">
									</figure>
									<a class="btn-read" href="/curriculum/index.php">
										<img class="img-read" src="/common/img/main/logo-read-w.png" alt="Read More">
										<img  class="img-read2"src="/common/img/main/logo-read2-w.png" alt="Read More">
					  ...
					  <div class="swiper-slide" role="curriI">
						<div class="item_wrap">
							<a href="/curriculum/index.php">
								<div class="item-img">
									<figure class="img-frame">
										<img src="/common/img/main/curri-after-care.jpg?v=2407021421" alt="커리큘럼">
									</figure>
									<a class="btn-read" href="/curriculum/index.php">
										<img class="img-read" src="/common/img/main/logo-read-w.png" alt="Read More">
										<img  class="img-read2"src="/common/img/main/logo-read2-w.png" alt="Read More">
